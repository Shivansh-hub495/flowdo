...
const AddAchievementModal: React.FC<AddAchievementModalProps> = ({ open, onOpenChange, onAchievementCreated }) => {
  const { createAchievement, uploadAchievementImage } = useAchievements();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (selectedImage) {
        imageUrl = await uploadAchievementImage(selectedImage);
        if (!imageUrl) {
